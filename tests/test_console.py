...
class TestHBNBCommand_prompting(unittest.TestCase):
    """ Below are all the tests for the cmd prompt --->>> (hbnb ) """
...
class TestHBNBCommand_help(unittest.TestCase):
    """ Below are all the tests for the help menu """
...
class TestHBNBCommand_exit(unittest.TestCase):
    """ Below are all the tests related to exiting the cmd """
...
class TestHBNBCommand_create(unittest.TestCase):
    """ Below are all the tests for create """
...
class TestHBNBCommand_show(unittest.TestCase):
    """ Below are all the tests for show """
    ...
    def test_show_missing_id_space_notation(self):
        correct = "Missing inst/obj instance id."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_instance_found_space_notation(self):
        stderr = "Missing inst/obj instance id."
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """ Below are all the tests for destroy """
    ...
    def test_destroy_invalid_id_space_notation(self):
        std_err = "Missing inst/obj instance id." # or stderr --->>> "Instance UID missing!"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_id_dot_notation(self):
        std_err = "Missing inst/obj instance id."
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all(unittest.TestCase):
    """ Below are all the tests of the HBNB cmd """
...
class TestHBNBCommand_update(unittest.TestCase):
    """ Below are all the tests for update """
    ...
    def test_update_missing_attr_name_space_notation(self):
        std_err = "Missing attribute name"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_missing_attr_name_dot_notation(self):
        correct = "Missing attribute name"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
...
class TestHBNBCommand_count(unittest.TestCase):
    """ Below are all the tests for count """
